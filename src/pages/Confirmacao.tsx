  ...
  if (!ultimo) {
    return (
      <div className="bg-[url('/imagens-do-projeto/imagemfundovitta.jpg')] bg-[length:50%]">
        <Header />
        <Navbar />
        <main className="font-['Oswald'] bg-[#F8F5F1] shadow-md w-full max-w-2xl mx-auto px-10 py-8 my-8 rounded-2xl text-center">
          <h1 className="text-3xl text-[#3B5C75] mb-6">Nenhum agendamento encontrado!</h1>
  ...
  return (
    <div className="bg-[url('/imagens-do-projeto/imagemfundovitta.jpg')] bg-[length:50%]">
      ...
      <main className="font-['Oswald'] bg-[#F8F5F1] shadow-md w-full max-w-2xl mx-auto px-10 py-8 my-8 rounded-2xl text-center">
        ...
        <h1 className="bg-[#3B5C75] text-white text-4xl px-5 py-5 text-center mb-8">Agendamento Confirmado!</h1>

        <div className="bg-white rounded-2xl shadow-md p-8 text-left mb-8">
          <h2 className="text-2xl font-bold text-[#3B5C75] mb-6">Resumo do agendamento</h2>
          ...
          <div className="flex flex-col gap-4 font-['Roboto']">
            ...
            <div className="flex justify-between border-b pb-3">
              ...
              <span className="text-gray-800">{ultimo.email}</span>
            </div>
            <div className="flex justify-between border-b pb-3">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <Link
            to="/"
            className="bg-[#3B5C75] text-white px-8 py-3 rounded-xl hover:bg-[#2a4558] transition-all text-lg"
          >
            Voltar ao início
          </Link>
          <Link
            to="/agendamento"
            className="bg-white border-2 border-[#3B5C75] text-[#3B5C75] px-8 py-3 rounded-xl hover:bg-[#3B5C75] hover:text-white transition-all text-lg"
          >
            Novo agendamento
          </Link>
        </div>
