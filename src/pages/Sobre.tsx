  ...
  return (
    <div className="bg-[url('/imagens-do-projeto/imagemfundovitta.jpg')] bg-[length:50%]">
      ...
      <main className="font-['Oswald'] bg-[#F8F5F1] shadow-md w-full max-w-5xl mx-auto px-20 py-8">
        <h1 className="bg-[#3B5C75] text-white text-4xl px-5 py-5 text-center mb-6">Sobre Nós</h1>
        ...
        <div className="mb-6">
          ...
          <ul className="font-['Roboto'] text-xl px-10 list-disc mb-4">
          ...
          <h2 className="bg-[#3B5C75] text-white text-3xl px-5 py-2 mb-4">Tecnologias utilizadas</h2>
          <p className="font-['Roboto'] text-xl px-5 mb-4">Para desenvolver nosso site utilizamos tecnologias que garantem eficiência, segurança e acessibilidade.</p>

          <h2 className="bg-[#3B5C75] text-white text-3xl px-5 py-2 mb-4">💻 Front-end</h2>
          <p className="font-['Roboto'] text-xl px-5 mb-4">HTML5 e CSS3 – Responsáveis pela estrutura e pelo design do site.</p>

          <h2 className="bg-[#3B5C75] text-white text-3xl px-5 py-2 mb-4">⚙️ Back-end</h2>
          <p className="font-['Roboto'] text-xl px-5 mb-4">Java – Linguagem principal utilizada na construção da lógica de funcionamento do sistema.</p>
          <p className="font-['Roboto'] text-xl px-5 mb-4">Python – Empregado no processamento de dados e automação de tarefas internas.</p>
          <p className="font-['Roboto'] text-xl px-5 mb-4">Oracle Database – Banco de dados utilizado para armazenar cadastros, agendamentos e históricos.</p>

          <h2 className="bg-[#3B5C75] text-white text-3xl px-5 py-2 mb-4">🔐 Segurança e Acessibilidade</h2>
          <p className="font-['Roboto'] text-xl px-5 mb-4">Implementação de criptografia de dados para proteger as informações pessoais dos pacientes.</p>

          <h2 className="bg-[#3B5C75] text-white text-3xl px-5 py-2 mb-4">💬 Integrações</h2>
          <p className="font-['Roboto'] text-xl px-5 mb-4">WhatsApp – Canal direto de comunicação entre os pacientes e a equipe de atendimento.</p>
        </div>
